    ...
    <div className="w-full p-4 h-full">
      ...
      >
        ...
        <div className="grid grid-cols-12 gap-4 auto-rows-min">
          {/* First row */}
          <div
            className="col-span-3 row-span-2 w-full h-64 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          <div
            className="col-span-6 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          <div
            className="col-span-3 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          {/* Second row */}
          <div
            className="col-span-4 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          <div
            className="col-span-2 row-span-2 w-full h-64 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          {/* Third row */}
          <div
            className="col-span-2 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          <div
            className="col-span-4 row-span-2 w-full h-64 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          {/* Fifth row */}
          <div
            className="col-span-5 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
          ...
          {/* Ninth row */}
          <div
            className="col-span-12 row-span-1 w-full h-32 rounded-lg bg-black overflow-hidden relative cursor-pointer"
            onClick={() => handleImageClick(34)}
          >
            <img
