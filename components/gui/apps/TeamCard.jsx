...
export default function TeamCard({ name, role, description, avatar, instagram, linkedin }) {
  return (
    <div className="bg-[#1e1e1e]/80 backdrop-blur-md rounded-3xl p-6 w-72 border border-gray-700 shadow-md transition-all duration-300 flex flex-col items-center text-white hover:shadow-[0_0_20px_#00ff88]">
      {/* Role */}
